...
import {DarkMode} from '../../../common/utils';
  ...
  return (
    <div className="app">
      <div className="level">
        ...
        <button className="app__dark-mode-btn icon level-right" onClick={onClickDarkMode}>
          <FontAwesomeIcon icon={isDarkModeActive ? faSun : faMoon} color={isDarkModeActive ? '#FFA500' : undefined}/>
        </button>
